                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          height: 6.57,
                          width: 17.51,
                          decoration: BoxDecoration(border: Border.all(color: Color.fromRGBO(224, 224, 225, 1)), borderRadius: BorderRadius.all(Radius.circular(3.28))),
                        ),
                        Container(
                          height: 6.57,
                          width: 17.51,
                        ...
                        Container(
                          height: 6.57,
                          width: 17.51,
                          decoration: BoxDecoration(color: Color.fromRGBO(60, 60, 60, 1), borderRadius: BorderRadius.all(Radius.circular(3.28))),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      height: 55,
                      child: Text("24hrs health tracking & health \n                   updates",
                          style: GoogleFonts.fredoka(
                      ...
                      child: Row(
                        children: [
                          Text("Already have an account? ",
                              style: GoogleFonts.fredoka(
                                textStyle: const TextStyle(color: Color.fromRGBO(161, 161, 161, 1), fontSize: 15, fontWeight: FontWeight.w600),
                              )),
                          GestureDetector(
                            onTap: () {
                            ...
                            child: Text("Login ",
                                style: GoogleFonts.fredoka(
                                  textStyle: const TextStyle(color: Color.fromRGBO(0, 0, 0, 1), fontSize: 15, fontWeight: FontWeight.w700),
                                )),
                          ),
                        ],
                      ),
        ...
        child: FloatingActionButton(
          ...
          child: Row(
            children: [
              ...
              Text("Get Started",
                  style: GoogleFonts.fredoka(
                    textStyle: TextStyle(color: Color.fromRGBO(255, 255, 255, 0.9), fontSize: 20, fontWeight: FontWeight.w700),
                  )),
              SizedBox(
                width: 70,
              ),
