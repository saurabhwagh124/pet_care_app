...
class BoardingAppointmentCard extends StatelessWidget {
  final BoardingAppointmentModel appointment;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(
                Icons.access_time_outlined, 'Time:', appointment.time ?? 'N/A'),
            if (appointment.boarding != null)
              _buildInfoRow(Icons.business_outlined, 'Boarding:',
                  '${appointment.boarding?.name ?? 'Details N/A'}'),
            if (isPending) ...[
